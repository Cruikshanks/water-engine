...
export default {
  ...
  options: {
    ...
    //
    // We use import.meta.resolve() to get the absolute path to pino-pretty from within water-engine's own
    // node_modules. Without this, pino resolves the target relative to the consuming app (e.g., the external or
    // internal app) where pino-pretty is not installed.
    transport:
      process.env.NODE_ENV === 'development'
        ? { target: import.meta.resolve('pino-pretty'), options: { colorize: true } }
        : undefined,
